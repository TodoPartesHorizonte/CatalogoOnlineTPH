...
<head>
    ...
    {{
      ...
      "offers": {{
        ...
        "priceCurrency": "USD",
        "price": "0.00",
        "url": "https://todoparteshorizonte.github.io/CatalogoOnlineTPH/p/{id}.html"
      }}
    }}
    </script>
...
<body>
    ...
    for product in products:
        ...
        # Avoid creating files with weird names if id is weird (in products.js IDs are alphanumeric UUIDs mostly, or WhatsApp Image...)
        # We will create safe filenames. Some IDs have spaces like 'WhatsApp Image ...'
