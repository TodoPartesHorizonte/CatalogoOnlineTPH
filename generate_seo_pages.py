    ...
    <script>
      ...
      window.addEventListener('load', function() {{
        setTimeout(function() {{
          ...
          var catBadge = document.querySelector('.category-badge span');
          var prodImg = document.querySelector('.product-img');
          
          var pName = titleEl ? titleEl.innerText.trim() : '';
          var pCat = catBadge ? catBadge.innerText.trim() : '';
          var pPhoto = prodImg ? prodImg.getAttribute('src') : '';
          var pId = window.location.pathname.split('/').pop().replace('.html', '');
